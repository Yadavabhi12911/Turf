            ...
            <>
                ...
                <div className="form-group">
                    <div className= "form-control-1"> 
                        ...
                        <input type="text" className="form-control inptP" id="username" value={this.props.profile.username} onChange={this.usernamechange}/>
                </div>
                ...
                <div className="form-group">
                        ...
                        <input type="text" className="form-control bg-gray-950" id="emailid" value={this.props.profile.emailid} onChange={this.emailidchange} onBlur={this.emailidblur}/>
                </div>
