...
function Description1(props) {
    return (
        ...
        <div className="container  text-center bg-transparent "  >
            ...
            <h3>It's now easy to book turf. Sweat it out only on the field now.</h3> 
  ...
  <div class="z-10 flex flex-col items-center gap-2">
    <span class="text-slate-400 text-6xl font-bold">Hello 
 Sir</span>
 
    <p class="text-gray-50"> Admin@gmail.com ||1234</p>
    
     <p>  </p>
     <p class="text-gray-50"> User@gmail.com ||1234</p>
  </div>
</div>
            </div>
        </div>
